...
/*
    Another case may be whenever a function receives a parameter that it should then use to build out an object.
*/
...
console.log(getEnvelope('Teste', 'This is a teste on ES5.'));
console.log('***');

//On ES6 computed property names help us write the same function more concisely, using a single statement.

function getEnvelopeEs6(type, description){
    return {
        data: {},
        [type]: description
    };
...
console.log(getEnvelopeEs6('Teste', 'This is a teste on ES6'));
console.log('-----------------------------------------');
